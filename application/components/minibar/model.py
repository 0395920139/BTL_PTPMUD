...
# class Minibar(CommonModel):
#     __tablename__ = 'minibar'
...
#     minibar_items = db.relationship("Item", secondary = 'booking_spa_item_relations')
...
#     __tablename__ = 'minibar_item_relations'
